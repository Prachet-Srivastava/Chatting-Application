...
class _ChatPageState extends State<ChatPage>
{
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text(widget.recieverUserEmail),backgroundColor: Colors.redAccent,),
      body: Column(
        children: [
          // Messages
    ...
    return Container(
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            Text(data['senderEmail'],style:  TextStyle(color: Colors.blueGrey),),
      ...
      child: Row(
        children: [
          ...
          IconButton(
            ...
            icon: const Icon(
              Icons.arrow_upward,color: Colors.blueGrey,
              size: 40,),
          )
